...
using complex_num = complex<float>;

int main()
{
	auto num1 = complex_num{2.0, 2.0};  // use auto for type deduction
	auto num2 = complex_num{4.0, -2.0}; // use uniform initialisation syntax (curly braces)
